function _factorize!(D::Vector{Float64}, U::Array{Float64, 2},W::Array{Float64, 2},ϕ::Array{Float64,2},coeffs::Tuple, x::Vector{Float64}, Σy::Diagonal{Float64}) #where T <: Real
